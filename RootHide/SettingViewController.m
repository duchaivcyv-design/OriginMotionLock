...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Reset accessory view to prevent reuse bugs
    ...
    if ([item[@"type"] isEqualToString:@"switch"]) {
        ...
        if (item[@"disabled"]) {
            [theSwitch setEnabled:![item[@"disabled"] boolValue]];
        }
...
- (void)switchChanged:(id)sender {
    ...
    CGPoint pos = [switchInCell convertPoint:CGPointZero toView:self.tableView];
